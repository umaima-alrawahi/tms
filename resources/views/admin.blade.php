        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <a class="cat-item d-block bg-light text-center rounded p-3" href="/reportslist">
                        <div class="rounded p-4">
                            <div class="icon mb-3">
...
<div class="col-lg-9">
  <div class="right_header_info">
      <ul>
          ...
          <li class="menu_iconb">
          <a href="../authentication/logout.php">Logout<i class="fa fa-external-link-square"></i> </a>
          </li>
          <li class="menu_iconb">
          <a href="signup.php">New Employee<i class="fa fa-user"></i></a>
          </li>
